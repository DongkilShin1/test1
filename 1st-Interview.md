...
##### 마이크로 서비스 약점
- 분산 시스템 개발은 일반 개발보다 복잡: 모든 것이 독립적인 서비스이기 때문에 __각 모듈간의 인터페이스를 신중하게 처리__해야 합니다. 서비스중 하나가 응답하지 않게 될 경우에 대한 방어코드도 작성해야 합니다. 호출 대기 시간이 발생하게 되면 복잡한 상황이 발생할 수 있습니다.
